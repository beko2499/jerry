...
Gold_Params =  {'type': 'subscription','page': '1','limit': '50','lang': 'ar','theme': 'avocado',}
Gold_Response = requests.get('https://odpapp.asiacell.com/api/v1/cdr/detail',params=Gold_Params,headers=Gold_Headers).text
print(Gold_Response)