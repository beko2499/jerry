...
Gold_Params =  {'lang': 'ar',}
Gold_Json = {'captchaCode': '','username': '077',} # - الرقم
Gold_Response = requests.post('https://odpapp.asiacell.com/api/v1/login',params=Gold_Params,headers=Gold_Headers,json=Gold_Json).text
print(Gold_Response)